...
public class CaretakerControllerTest {
    ...
    public void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(caretakerController).build();
...
//        caretakerDetails.setDob(localDate);
    ...
    public void givenGetAllCaretakersThenShouldReturnListOfAllCaretakers() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/caretakers")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(caretaker1)))
                .andDo(MockMvcResultHandlers.print());
        verify(caretakerService).getAllCaretakers();
        verify(caretakerService, times(1)).getAllCaretakers();
    ...
    void givenCaretakerIdThenShouldReturnRespectiveCaretaker() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/caretakers/bhadwaldiksha8"))
